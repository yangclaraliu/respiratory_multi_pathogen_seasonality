...
Where within- and between-year patterns play a role, the circulation of seasoanl respiratory pathogens may peak concurrently.
...
Furthermore, the statistical validity of the role played by between-year patterns needs to be validated by multiple datasets, which requires the type of data we mentioned above, which is already rare, needs to be available for multiple locations.
...
Seasonal level forecasts have been widely used in the context of vector-borne infectious diseases, and therefore their value to managing respiratory health worth further exploration.
To achieve this, we face two key technical challenges.
First, methods designed for identifying single cyclical components may mischaracterise bewteen-year patterns as residual noises. 
...
Using long-term surveillance data of seasonal influenza and RSV longer than five years for eight cities in mainland China spanning various climate zones, we developed an analytical framework that combines time-series statistics and survival analysis to quantify the probability of a concurrent outbreak and the interval to the sebsequent concurrent outbreak. 
Although the estimates we provide focus on seasonal influenza and RSV, our framework is widely adaptable to studying other respiratory pathogens with continuous measured data descirbing their disease burden.
