...
In the context of this study, we used the time by which 50\% of the forward simulation paths ($1000 \times n$ models) are expected to experience their next concurrent outbreak event as the inter-concurrent outbreak interval. 
