...
Among the studies they identified, we found 9 datasets to meet our criteria above.
...
Of these cities, Beijing, Lanzhou, and Xi'an are located in the northern part of mainland China, and the rest are located in the southern part \cite{Hu_1935_HuHuanyongLine}.
...
Data embedded in figures were digitised using WebPlotDigitizer-4.7.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{../figures/fig 1/Fig1.png}
